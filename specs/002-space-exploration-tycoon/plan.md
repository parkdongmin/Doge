...
> **구현 현황 (2026-07-08)**: Phase 1~6 전체 구현 완료 (도메인 모델·데이터 레이어·UseCase·네비게이션·화면·알림 워커 모두 반영). 이후 변경 사항(자원 판매, 탐사 결과 처리 안정화 등)은 이 문서에 소급 반영하지 않으며, 남은 미결 사항은 [spec.md의 미결 사항](spec.md#미결-사항-2026-07-08-기준-구현-현황) 참고.
